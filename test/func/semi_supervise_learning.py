...
def get_the_whole_img_set_dict(unlabelled_img_file_path = "/data0/wangad/Airway/LIDC-IDRI_3D/raw_data", indicator = "LIDC_IDRI_"):
...
def init_the_teacher_model(model_arch, in_channel, out_channel, load_path):
...
def save_the_study_materials_for_one_img(raw_img, seg_onehot, chosen_pic_name,
                                         ...
                                         output_file_path = "/data0/wangad/Airway/LIDC-IDRI_3D/temp",
...
def use_teacher_model_to_process_one_list_of_img_and_save_study_materials(pic_name_list, whole_img_set_dict,
                                                                          teacher_model,
                                                                          device = torch.device('cuda:1' if torch.cuda.is_available() else 'cpu'),
                                                                          file_path_of_study_materials = "/data0/wangad/Airway/LIDC-IDRI_3D/temp",
