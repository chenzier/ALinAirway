...
class Encoder(nn.Module):
    ...
    def __init__(
        ...
        if use_dsc:
            ...
            self.conv2x33 = DCN_Conv(
                in_ch=middle_channels // 2,
                out_ch=middle_channels // 2,
                kernel_size=3,
                extend_scope=1.0,
                morph=0,
                if_offset=True,
            )
            self.conv2y33 = DCN_Conv(
                in_ch=middle_channels // 2,
                out_ch=middle_channels // 2,
                kernel_size=3,
                extend_scope=1.0,
    ...
    def forward(self, x):
        ...
        if self.use_dsc:
            x_2_0 = self.conv20(x)
            x_2x_33 = self.conv2x33(x_2_0)
            x_2y_33 = self.conv2y33(x_2_0)
...
class Decoder(nn.Module):
    ...
    def __init__(
        ...
        if self.use_dsc:
            ...
            self.conv2y33 = DCN_Conv(
                in_ch=conv_middle_channels // 2,
                out_ch=conv_middle_channels // 2,
                kernel_size=3,
                extend_scope=1.0,
                morph=1,
                if_offset=True,
